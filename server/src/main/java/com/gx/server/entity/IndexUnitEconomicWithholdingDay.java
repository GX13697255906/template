...
@NoArgsConstructor
@TableName("biz_index_unit_economic_withholding_day")
@ApiModel(value="IndexUnitEconomicWithholdingDay对象", description="机组经济持留天表")
public class IndexUnitEconomicWithholdingDay extends AbstractEntity {
