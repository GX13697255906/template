...
@NoArgsConstructor
@TableName("biz_tie_line_change_power")
@ApiModel(value="TieLineChangePower对象", description="联络线交换功率表")
public class TieLineChangePower extends AbstractEntity {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "联络线交换功率表id")
    @TableId(value = "id", type = IdType.ID_WORKER)
    private Long id;

    @ApiModelProperty(value = "联络线名称")
