...
@NoArgsConstructor
@TableName("biz_index_wac_price_day")
@ApiModel(value="IndexWacPriceDay对象", description="综合加权平均电价指标-天表")
public class IndexWacPriceDay extends AbstractEntity implements Serializable {
