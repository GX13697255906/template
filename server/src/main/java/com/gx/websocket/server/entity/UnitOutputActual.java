...
@Data
@NoArgsConstructor
@TableName("biz_unit_output_actual")
@ApiModel(value="UnitOutputActual对象", description="机组实际出力信息表")
public class UnitOutputActual extends AbstractEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "机组实际出力信息ID")
