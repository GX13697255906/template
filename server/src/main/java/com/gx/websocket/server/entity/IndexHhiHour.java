...
@NoArgsConstructor
@TableName("biz_index_hhi_hour")
@ApiModel(value="IndexHhiHour对象", description="HHI指标表-时度")
public class IndexHhiHour extends AbstractEntity implements Serializable {
    ...
    @ApiModelProperty(value = "小时（hh:00:00）")
    private String hour;
