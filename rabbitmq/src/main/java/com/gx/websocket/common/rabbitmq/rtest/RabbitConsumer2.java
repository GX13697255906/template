...
public class RabbitConsumer2 {
    ...
    public static void main(String[] args) {
        RabbitConsumer2 consumer = new RabbitConsumer2();
//        consumer.directConsumer();
        consumer.fanoutConsumer_1();
    }
...
//            channel.basicConsume(RabbitDetailsEnum.DIRECT_LOG.getQueue(), true, consumer);
    ...
    public void fanoutConsumer_1() {
        RabbitMqConfiguration configuration = new RabbitMqConfiguration();
        Channel channel = configuration.channel;
        try {
            String exchange = RabbitDetailsEnum.FANOUT_API_1.getExchange();
            String exchangeType = RabbitDetailsEnum.FANOUT_API_1.getExchangeType();
            String queue = RabbitDetailsEnum.FANOUT_API_1.getQueue();
            String routingKey = RabbitDetailsEnum.FANOUT_API_1.getRoutingKey();
