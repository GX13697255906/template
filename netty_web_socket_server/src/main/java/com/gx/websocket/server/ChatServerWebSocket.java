...
public class ChatServerWebSocket {
    ...
    public void bind() {
        ...
        bootstrap.group(bossGroup, workGroup)
                ...
                .childHandler(new ChatServerWebSocketChannelHandler());

        try {
            //        绑定端口，同步等待连接
            channelFuture = bootstrap.bind(Constants.Web_Socket_Prot).sync();
    ...
    public static void main(String[] args) {
        ...
        ChatServerWebSocket chatServer = new ChatServerWebSocket();
        chatServer.bind();
