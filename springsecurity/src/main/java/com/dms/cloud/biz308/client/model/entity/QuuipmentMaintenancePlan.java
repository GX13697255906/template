...
@NoArgsConstructor
@TableName("biz_quuipment_maintenance_plan")
@ApiModel(value="QuuipmentMaintenancePlan对象", description="关键设备检修停复电计划表")
public class QuuipmentMaintenancePlan extends AbstractEntity {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "关键设备检修停复电计划id")
    ...
    @ApiModelProperty(value = "检修申请单号(对应的检修申请单编号，如果没有请任 意给一数字，不能为空)")
    ...
    @ApiModelProperty(value = "停运或启用开始时间 (yyyymmdd_hhmmss)")
    private String startTime;

    @ApiModelProperty(value = "停运或启用结束时间 (yyyymmdd_hhmmss)")
