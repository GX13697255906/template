 ...
 */
@Slf4j
public class DataSyncWebSockeHandler extends SimpleChannelInboundHandler<Object> {

    private DataSyncWebSocket startWebSocket;

    public DataSyncWebSockeHandler(DataSyncWebSocket startWebSocket) {
    ...
    public void channelActive(ChannelHandlerContext context) throws Exception {
        DataSyncWebSocketConfig.group.add(context.channel());
    ...
    public void channelInactive(ChannelHandlerContext context) throws Exception {
        DataSyncWebSocketConfig.group.remove(context.channel());
    ...
    public void exceptionCaught(ChannelHandlerContext context, Throwable throwable) throws Exception {
        log.info("服务端重新创建连接 时间：{}", DateUtil.format(new Date(), "yyyy-MM-dd HH:mm:ss"));
        startWebSocket.bind();
    }
    ...
    private void handWebSocketFrame(ChannelHandlerContext context, WebSocketFrame webSocketFrame) {
        ...
        //服务端向每个连接上来的客户端发送消息
        DataSyncWebSocketConfig.group.writeAndFlush(textWebSocketFrame);
    }
